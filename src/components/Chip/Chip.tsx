...
/**
 * A set of filter chips: independent toggles, any number of them selected. Each chip needs a
 * `value`. Chips wrap on several lines; arrow keys move between them.
 *
 * For a single choice among a few options, use `Segmented`.
 *
