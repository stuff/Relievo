    ...
    <div style={{ display: 'grid', gap: 'var(--rv-space-6)', width: 'min(100%, 44rem)' }}>
      ...
      <Card as="section" tone="warning">
        <Card.Header>
          ...
          <Card.Description>
            Canvas tote is low on stock and Leather boots failed to sync.
          </Card.Description>
        </Card.Header>
        <Card.Footer>
          <ButtonGroup>
      ...
      <Tabs label="Products" defaultValue="all">
        <Tabs.List>
          ...
          <Tabs.Item value="low" startIcon={<WarningIcon />}>
            Low stock 1
          </Tabs.Item>
          <Tabs.Item value="archived" startIcon={<ArchiveIcon />}>
            Archived 0
          </Tabs.Item>
        </Tabs.List>
              ...
              <div style={stack}>
                ...
                <Stack gap="sm" separator>
                  ...
                  <div style={{ ...row, justifyContent: 'space-between' }}>
                    <Checkbox
                      ...
                      onCheckedChange={(checked) =>
                        setSelected(checked ? products.map((product) => product.name) : [])
                      }
                    />
                  ...
                  {products.map((product) => (
                    <div key={product.name} style={{ ...row, flexWrap: 'nowrap' }}>
                      <Checkbox
                      ...
                      <span style={{ ...text, width: '4rem', textAlign: 'end' }}>
                        {product.price}
                      </span>
        ...
        <Tabs.Panel value="low" variant="framed">
          Canvas tote is down to 3 units.
        </Tabs.Panel>
        <Tabs.Panel value="archived" variant="framed">
          ...
          <div style={stack}>
            ...
            <Stack gap="sm">
              <Checkbox
                ...
                defaultChecked
                helperText="Customers can find and buy it."
              />
